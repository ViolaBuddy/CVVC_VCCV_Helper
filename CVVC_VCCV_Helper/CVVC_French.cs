...
{
    static class CVVC_French
    {
        //public static readonly Regex French_RE = new Regex(@"(.*?)(a|ai|e|eh|en|eu|i|in|o|on|oo|ou|u|ui|oi)(.*?)");
        public static readonly string vowels_RE_str = @"a|A|O|e|E|&|@|i|I|o|3|W|U|u|8";
        public static readonly string consonants_RE_str = @"b|d|f|g|j|k|l|m|n|p|r|s|sh|t|v|w|y|z";
        public static readonly string starting_blends_RE_str =
            @"br|bl|by|dr|dy|fr|fl|fy|gr|gl|gy|j|kr|kl|kw|ky|pr|pl|py|st|sy|tr|ts|ty|vl|vy|zy";
        public static readonly string ending_blends_RE_str =
            @"b|d|f|g|j|k|l|m|n|p|r|s|sh|sk|st|t|v|w|y|z";
